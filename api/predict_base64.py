...
input_parser.add_argument(
    ...
    help="Base64 encoded signed 16-bit PCM WAV audio file",
)
input_parser.add_argument(
    "start_time",
    type=float,
...
class ModelBase64PredictAPI(PredictAPI):
    ...
    def post(self):
        ...
        try:
            audio_data = base64.b64decode(args["audio"])
        except Exception as e:
            e = BadRequest()
            e.data = {
                "status": "error",
                "message": "Invalid base64 audio data: " + str(e),
            }
            raise e
